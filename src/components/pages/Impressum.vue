<template>
    <div class="container" style="background-color: #fffc; border-radius: 5px">
    <div class='impressum'><h1>Impressum</h1><p>Angaben gemäß § 5 TMG</p>
        <p>Dimitri Knippenberg <br>
        Ludwig-Mond-Str. 90<br>
        34121 Kassel <br>
    </p>
        <p> <strong>Vertreten durch:</strong><br>
        Dimitri Knippenberg<br>
    </p>
        <p><strong>Kontakt:</strong> <br>
        Telefon: 0159-02166068<br>
        E-Mail: <a href='mailto:d.knippenberg@gmx.net'>d.knippenberg@gmx.net</a><br></p><p><strong>Haftungsausschluss: </strong><br><br><strong>Haftung für Inhalte</strong><br><br>
